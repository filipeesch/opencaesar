...
export const HOUSING_LEVELS: readonly HousingLevelDef[] = [
  ...
  { level: 15, name: 'Average Small Villa', capacity: 320, taxPerCapita: 15, footprint: 3, requires: ['market', 'fountain', 'hospital', 'school', 'library', 'theatre', 'temple', 'amphitheatre', 'forum', 'garden'], requiresGoods: ['wheat', 'pottery', 'vegetables', 'fruit', 'fish', 'meat', 'furniture', 'wine', 'oil', 'tools'], desirability: 15 },
  { level: 16, name: 'Good Small Villa', capacity: 340, taxPerCapita: 16, footprint: 3, requires: ['market', 'fountain', 'hospital', 'school', 'library', 'theatre', 'temple', 'amphitheatre', 'forum', 'garden', 'senate'], requiresGoods: ['wheat', 'pottery', 'vegetables', 'fruit', 'fish', 'meat', 'furniture', 'wine', 'oil', 'tools'], desirability: 16 },
  { level: 17, name: 'Poor Big Villa', capacity: 360, taxPerCapita: 17, footprint: 3, requires: ['market', 'fountain', 'hospital', 'school', 'library', 'theatre', 'temple', 'amphitheatre', 'forum', 'garden', 'senate'], requiresGoods: ['wheat', 'pottery', 'vegetables', 'fruit', 'fish', 'meat', 'furniture', 'wine', 'oil', 'tools'], desirability: 17 },
  { level: 18, name: 'Average Big Villa', capacity: 380, taxPerCapita: 18, footprint: 3, requires: ['market', 'fountain', 'hospital', 'school', 'library', 'theatre', 'temple', 'amphitheatre', 'forum', 'garden', 'senate'], requiresGoods: ['wheat', 'pottery', 'vegetables', 'fruit', 'fish', 'meat', 'furniture', 'wine', 'oil', 'tools'], desirability: 18 },
  { level: 19, name: 'Good Big Villa', capacity: 400, taxPerCapita: 19, footprint: 4, requires: ['market', 'fountain', 'hospital', 'school', 'library', 'theatre', 'temple', 'amphitheatre', 'forum', 'garden', 'senate'], requiresGoods: ['wheat', 'pottery', 'vegetables', 'fruit', 'fish', 'meat', 'furniture', 'wine', 'oil', 'tools'], desirability: 19 },
  { level: 20, name: 'Luxury Villa', capacity: 420, taxPerCapita: 20, footprint: 4, requires: ['market', 'fountain', 'hospital', 'school', 'library', 'theatre', 'temple', 'amphitheatre', 'forum', 'garden', 'senate', 'grand_temple'], requiresGoods: ['wheat', 'pottery', 'vegetables', 'fruit', 'fish', 'meat', 'furniture', 'wine', 'oil', 'tools'], desirability: 20 },
];
